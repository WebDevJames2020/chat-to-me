...
app.post("/index.html", function (req, res) {
  ...
  const openFun = async () => {
    ...
    res.write(
      "<br><br><br></p><button style='display:block; margin: 0 auto; background-color: #3498db; color: #fff; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-size: 16px; transition: background-color 0.3s;text-decoration: none;'><a href='https://boundless-soap-production.up.railway.app/'>Ask another question</a></button>"
    );
    res.send();
  };
  openFun();
