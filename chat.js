...
app.post("/index.html", function (req, res) {
  ...
  const openFun = async () => {
    ...
    res.write(
      "<br><br><button style='display:block; margin: 0 auto; background-color: #3498db; color: #fff; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-size: 16px; transition: background-color 0.3s;'><a href='https://blackbrush.co.uk' style='color: #fff; text-decoration: none'>Go back to my website</a></button>"
    );
    res.send();
  };
  openFun();
